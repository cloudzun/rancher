...
az vm open-port --resource-group rancherlab --name node2 --port 443 --priority 1001
az vm open-port --resource-group rancherlab --name node2 --port 80 --priority 1002
...
az vm open-port --resource-group rancherlab --name node3 --port 443 --priority 1001
az vm open-port --resource-group rancherlab --name node3 --port 80 --priority 1002
